...
) ENGINE=InnoDB AUTO_INCREMENT=16 DEFAULT CHARSET=euckr COLLATE=euckr_bin;
...
CREATE TABLE `team` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `name` varchar(100) COLLATE euckr_bin NOT NULL,
  `owner` varchar(50) COLLATE euckr_bin NOT NULL,
  `created_date` datetime DEFAULT CURRENT_TIMESTAMP,
  PRIMARY KEY (`id`)
) ENGINE=InnoDB DEFAULT CHARSET=euckr COLLATE=euckr_bin;
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `todo` (
  ...
  `desc` varchar(3000) COLLATE euckr_bin NOT NULL,
  `team_id` int(11) NOT NULL,
...
-- Dump completed on 2020-09-09 22:09:24
